...
<context>
    ...
    <message>
        ...
        <translation>Це полегшує надсилання та отримання Tabo і знижує кількість помилок при введенні адрес вручну.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ПОПЕРЕДЖЕННЯ: Не використовуйте повторно свої ключі Tabo в іншому форку, ЯКЩО ТІЛЬКИ цей форк не має вбудованих засобів захисту від компрометації введених ключів. Подібні дії можуть зашкодити вашій конфіденційності.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вбудована версія Tabo: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Використовувати сторонній вузол для підключення до мережі Tabo. Менш безпечно, але більш зручно.</translation>
    </message>
    <message>
        ...
        <translation>Щоб отримати список віддалених нод, введіть &apos;Tabo remote node&apos; у вашій улюбленій пошуковій системі. Будь ласка, переконайтеся, що обраній ноді можна довіряти.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На цій сторінці можна взаємодіяти із загальною базою даних RingDB. Ця база даних призначена для використання гаманцями Tabo або їх клонів, які зможуть повторно використовувати ключі Tabo.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того щоб приховати які входи в транзакціях Tabo були витрачені, третя сторона не повинна повідомляти які входи в кільці вже задіяні в витраті. Адже якщо це зробити, то це послабить захист, який забезпечується кільцевими підписами. Якщо відомо, що всі, крім одного з входів, вже витрачені, то фактично трата входу стає очевидною, тим самим анулюється ефект кільцевих підписів, одного з трьох основних рівнів захисту конфіденційності Tabo.&lt;br&gt;Щоб допомогти транзакціям уникнути витрати цих входів, можна використовувати список відомих витрачених входів, щоб уникнути їх використання в нових транзакціях. Такий список підтримується проектом Tabo і доступний на веб-сайті gettabo.org, і ви можете імпортувати цей список тут.&lt;br&gt;Крім того, ви можете просканувати блокчейн (і блокчейни клонів Tabo) самостійно, використовуючи інструмент tabo-blockchain-mark-spent-outputs, щоб створити список відомих витрачених входів.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Щоб уникнути скасування захисту, що забезпечується кільцевими підписами Tabo, вихід не повинен проводитися з різними кільцями на різних блокчейнах. Хоча це як правило не викликає занепокоєння, він може стати одним, якщо якийсь клон Tabo, що використовує ключ повторно, дозволяє вам витрачати існуючі виходи. В цьому випадку вам необхідно забезпечити, щоб ці існуючі виходи використовували одне і те ж кільце для обох блокчейнів.&lt;br&gt;Це може бути зроблено автоматично, або будь-яким програмним забезпеченням з можливістю повторного використання ключів, яке не спробує позбавити вас конфіденційності.&lt;br&gt;Якщо ви використовуєте клон Tabo з повторним використанням ключа, і цей клон не включає цей захист, ви все одно можете гарантувати, що ваші транзакції будуть захищені, зробивши їх спочатку на клоні, потім вручну додати кільце на цій сторінці, що дозволить вам конфіденційно перевести ваші Tabo.&lt;br&gt;Якщо ви не використовуєте клон Tabo з повторним використанням ключів без цих функцій безпеки, то вам не потрібно нічого робити, оскільки все автоматизовано.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Тут записуються кільця, що використовуються виходами проведеними на Tabo, так що одне і те ж кільце можна використовувати повторно, щоб уникнути проблем з конфіденційністю.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введіть адресу Tabo (наприклад: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
Confirmation message:
    ...
    <message>
        ...
        <translation>Tabo відправлено успішно</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Щоб мати можливість обмінюватися даними з мережею Tabo, ваш гаманець повинен бути підключений до ноди Tabo. Для кращої конфіденційності рекомендується запустити свою власну ноду.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Окрім цього, ви можете вказати ноду швидкого завантаження, щоб негайно почати користуватися Tabo.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Виберіть цю опцію, якщо ви вперше користуєтесь Tabo.</translation>
    </message>
    <message>
        <location filename="../wizard/WizardHome.qml" line="104"/>
...
<context>
    ...
    <message>
        ...
        <translation>Тимчасове використання віддалених нод зручно для негайного використання Tabo (звідси назва &quot;початкове завантаження&quot;), однак пам&apos;ятайте, що при використанні віддалених нод (включаючи вибір початкового завантаження), ноди можуть відстежувати вашу IP адресу, відстежувати вашу &quot;висоту відновлення&quot; і відповідні дані запиту блоку, і відправляти вам неточну інформацію, щоб дізнатися більше про здійснені вами транзакції.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Цей режим ідеально підходить для управління невеликими сумами Tabo. У вас є доступ до основних функцій для здійснення транзакцій та управління ними. Програма автоматично підключиться до мережі Tabo, щоб ви відразу могли почати використовувати Tabo.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Щоб мати можливість обмінюватися даними з мережею Tabo, ваш гаманець повинен бути підключений до ноди Tabo. Для кращої конфіденційності рекомендується запустити свою власну ноду.
...
<context>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 TABO, із %2 підтвердженням(и).</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1066"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 TABO, але транзакція ще не була підтверджена майнерами</translation>
    </message>
    <message>
