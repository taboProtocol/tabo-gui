...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of tabo birth 2024-01-08 00:00:00 (1704643200)
    var moneroBirthTime = _nettype == "Mainnet" ? 1704643200 : _nettype == "Testnet" ? 1704643200 : 1704643200;
    // avg seconds per block in v1
    var secondsPerBlockV1 = 60;
    // time of v2 fork 2016-03-23 15:57:38 (1458748658)
    var forkTime = _nettype == "Mainnet" ? 1704643200 : _nettype == "Testnet" ? 1704643200 : 1704643200;
    // v2 fork block
    var forkBlock = _nettype == "Mainnet" ? 2 : _nettype == "Testnet" ? 2 : 2;
